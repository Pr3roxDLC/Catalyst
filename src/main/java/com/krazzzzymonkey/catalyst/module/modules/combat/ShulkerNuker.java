...
public class ShulkerNuker extends Modules {
    ...
    private final EventListener<ClientTickEvent> onClientTick = new EventListener<>(e -> {
        ...
        //stream = stream.filter(pos -> Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(219)));
        stream = stream.filter(pos -> Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(219))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(220))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(221))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(222))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(223))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(224))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(225))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(226))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(227))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(228))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(229))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(230))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(231))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(232))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(233))
                || Block.getIdFromBlock(Wrapper.INSTANCE.world().getBlockState(pos).getBlock()) == Block.getIdFromBlock(Block.getBlockById(234)));
    ...
    private final EventListener<PacketEvent> onPacket = new EventListener<>(e -> {
        if(e.getSide() == PacketEvent.Side.OUT) {
            ...
            if (packet instanceof CPacketPlayerDigging) {
                ...
                if ((Minecraft.getMinecraft().world.getBlockState(pck.getPosition()).getBlock() instanceof BlockShulkerBox)) {
