...
public class Utils {
    ...
    public static Vec3d getCenter(AxisAlignedBB bb) {
        return new Vec3d(bb.minX + (bb.maxX - bb.minX), bb.minY + (bb.maxY - bb.minY), bb.minZ + (bb.maxZ - bb.minZ));
    }
    ...
    public static boolean isPlayer(Entity entity) {
		if(entity instanceof EntityPlayer) {
            ...
            return entityName.equals(playerName);
		}
		return false;
    }
    ...
    public static boolean checkEnemyNameColor(EntityLivingBase entity) {
        ...
        return !getEntityNameColor(Wrapper.INSTANCE.player()).equals(getEntityNameColor(entity));
    }
	...
	public static boolean checkEnemyColor(EntityPlayer enemy) {
        ...
        return (colorEnemy0 != colorPlayer0 || colorPlayer0 == -1 || colorEnemy0 == 1)
    ...
    public static void faceVectorPacket(Vec3d vec)
	{
		...
		try {
			...
			onUpdateWalkingPlayer.invoke(pl);
		} catch(Exception ex) {}
	...
	public static boolean placeBlockScaffold(final BlockPos pos) {
        ...
        for (int length = (values = EnumFacing.values()).length, i = 0; i < length; ++i) {
            ...
            if (eyesPos.squareDistanceTo(new Vec3d(pos).add(0.5, 0.5, 0.5)) < eyesPos.squareDistanceTo(new Vec3d(neighbor).add(0.5, 0.5, 0.5)) && canBeClicked(neighbor)) {
