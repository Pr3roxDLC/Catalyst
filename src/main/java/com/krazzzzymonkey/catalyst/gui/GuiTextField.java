...
public class GuiTextField extends Gui {
    ...
    public GuiTextField(int componentId, CFontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox(int colorBox, int colorFrame) {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtils.drawBorderedRect(this.x - 1, this.y - 1, this.x + this.width + 1, this.y + this.height + 1, 1, colorFrame, colorBox);
            }
            ...
            if (!s.isEmpty()) {
                ...
                j1 = (int) this.fontRenderer.drawStringWithShadow(s1, (float) l, (float) i1, i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                j1 = (int) this.fontRenderer.drawStringWithShadow(s.substring(j), (float) j1, (float) i1, i);
            }
