...
public class GuiCustomButton extends GuiButton
{
	...
	{
		super(buttonId, b.posX, b.posY, b.width, b.height, I18n.format(b.text.get()));
	...
	{
		CFontRenderer fontrenderer = Main.fontRenderer;
	...
	public void func_191745_a(Minecraft mc, int mouseX, int mouseY, float partialTicks)
	{
		if (this.visible)
		{
			...
			this.drawCenteredString(fontrenderer, hovered ? I18n.format(StringReplacer.replacePlaceholders(b.hoverText.get())) : I18n.format(StringReplacer.replacePlaceholders(b.text.get())), this.x + this.width / 2 + b.textOffsetX, this.y + (this.height - 8) / 2 + b.textOffsetY, l, b.shadow);
		}
	}

	protected void drawHoveringText(Minecraft mc, List textLines, int x, int y, CFontRenderer font)
	{
	...
	public void drawCenteredString(CFontRenderer fontRendererIn, String text, int x, int y, int color, boolean shadow)
	{
		if (shadow)
		{
